    ...
    <div className="container m-auto py-5">
      <div className="bg-white py-5 px-10 rounded-md">
        ...
        <div className="mt-7 flex flex-col py-5 items-center gap-5">
          ...
          <div className="lg:w-[40%] w-[80%] p-3 flex flex-col gap-5">
              ...
              <div className="flex items-center gap-7">
                ...
                <p className="w-[80%] border border-gray-300 py-2 px-4 rounded-md">{currentUser.user?.userDetailId.phone}</p>
              </div>
              <div className="flex items-center gap-7">
                <h4 className="min-w-[20%] font-[600] text-gray-500">Ngày sinh:</h4>
                <p className="w-[80%] border border-gray-300 py-2 px-4 rounded-md">Hà Huy Bình</p>
              </div>
              <div className="flex items-center gap-7">
